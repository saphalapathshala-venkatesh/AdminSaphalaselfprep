...
- **Core Features**:
    ...
    - **Course & Faculty Entities**: Reusable across both Video and Live Classes modules. API: `/api/courses`, `/api/courses/[id]`, `/api/faculty`, `/api/faculty/[id]`.
    - **Sidebar MEDIA section**: Added between CONTENT and COMMERCE with Videos and Live Classes links.
